...
import { BriefcaseBusiness, ChevronLeft, ChevronRight, CircleUser, Github, GraduationCap, HandHelping, Handshake, Instagram, Linkedin, LogIn } from "lucide-react"
    ...
    return (
        <Styled.Container>
            ...
            >
                ...
                <Stack gap={5} justifyContent={"center"} sx={{ flex: 1, zIndex: 1, position: "relative" }}>
                    <Stack gap={2}>
                        <Typography
                            variant="h1"
                            fontWeight={600}
                        ...
                        >
                            O Nexus preenche a lacuna entre projetos escolares inovadores e empresas que buscam investir no próximo grande projeto.
                        </Typography>
                    </Stack>
            ...
            <Styled.Session gap={10} id="pqNexus">
                ...
                <Stack direction={{ xs: "column", md: "row" }} gap={5} alignItems={"center"}>
            ...
            >
                ...
                <Stack className="fundo">
                    <BackGroud width="100%" height="100%" preserveAspectRatio="xMidYMid slice" />
                </Stack>
                ...
                >
                    ...
                    <InfoCard
                        ...
                        sx={{ flex: 1, textAlign: "center" }}
                    >
                        <Stack gap={2} color="#FFFCF5">
                            <Stack gap={2} sx={{ alignItems: { xs: "center", md: "unset" } }}>
                            ...
                            <Stack>
                                <Typography variant="h5" fontWeight={100}>
                                    Estudantes e equipes acadêmicas têm a oportunidade de apresentar seus projetos de forma profissional, com descrições completas, imagens, vídeos e todas as informações necessárias para chamar a atenção de empresas e investidores.
                                    Essa é a vitrine onde o talento e a criatividade se tornam visíveis.
                                </Typography>
                            </Stack>
                        </Stack>
                    </InfoCard>
                    ...
                    >
                        <Stack gap={2} color="#FFFCF5">
                            ...
                            <Stack>
                                <Typography variant="h5" fontWeight={100}>
                                    Empresas, instituições e potenciais patrocinadores podem navegar por projetos filtrando por áreas de interesse, temas de inovação ou demandas do mercado.
                                    É uma maneira eficaz de encontrar soluções criativas e se conectar com jovens talentos ainda em formação.
                                </Typography>
                            </Stack>
                        </Stack>
                    </InfoCard>
                    ...
                    >
                        <Stack gap={2} color="#FFFCF5">
                            ...
                            <Stack>
                                <Typography variant="h5" fontWeight={100}>
                                    Por meio de uma interface simples e intuitiva, o Nexus permite que alunos e empresas conversem diretamente. A plataforma oferece recursos para envio de mensagens, agendamento de encontros e até propostas de apoio ou contratação.
                                    A colaboração começa com um clique.
                                </Typography>
                            </Stack>
                        </Stack>
                    </InfoCard>
                    ...
                    >
                        <Stack gap={2} color="#FFFCF5">
                            ...
                            <Stack>
                                <Typography variant="h5" fontWeight={100}>
                                    Projetos promissores podem atrair diferentes formas de apoio: financeiro, estrutural, técnico ou até visibilidade em eventos e redes corporativas.
                                    A plataforma é um elo entre quem tem boas ideias e quem pode ajudar a realizá-las.
                                </Typography>
                            </Stack>
                        </Stack>
                    </InfoCard>
            ...
            <Styled.Session gap={10} id="equipe">
                ...
                <Stack direction="row" alignItems="center" gap={{ xs: 0, sm: 2 }}>
                    <Button
                        tamanho={"md"}
                        somenteIcone
                        variante="ButtonOutlinedBlue"
                    ...
                    <Styled.DevCardsContainer id="dev-cards-container">
                        {[
                            ...
                            <InfoCard
                                ...
                                variante={"White"}
                                cor={"azul"}
                                sx={{ textAlign: "center", cursor: "pointer", width: 300, flexShrink: 0 }}
                            >
